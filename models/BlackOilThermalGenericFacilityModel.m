classdef BlackOilThermalGenericFacilityModel < GenericFacilityModel
%Generic facility model for geothermal simulations
    ...
    methods
        ...
        % Constructor
            ...
            ffd = ffd.setStateFunction('AdvectiveHeatFlux' , MultiphaseWellAdvectiveHeatFlux(model) );
            ffd = ffd.setStateFunction('ConductiveHeatFlux', MultiphaseWellConductiveHeatFlux(model));
